 ...
 *
 * You can also copy `js/maps-config.example.js` → `js/maps-config.js` inside an
 * existing site folder if that folder already ships an example next to the page.
 *
 * https://developers.google.com/maps/documentation/javascript/get-api-key
 */
window.__GMAPS_KEY__ = "YOUR_GOOGLE_MAPS_API_KEY";
