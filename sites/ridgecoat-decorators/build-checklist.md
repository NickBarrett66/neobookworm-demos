# Build Checklist — Ridgecoat Decorators Ltd
...
- [ ] Brief committed: *`ridgecoat-decorators`: brief complete*
...
- [ ] Spec committed: *`ridgecoat-decorators`: spec generated*
...
- [ ] `images/` contents verified (terminal `dir` / `ls` on absolute `sites/ridgecoat-decorators/images`, or read one file by path). Do not treat an empty workspace search as proof the folder is empty.
- [ ] Images committed: *`ridgecoat-decorators`: images added*
...
- [ ] Final Phase 4 commit: *`ridgecoat-decorators`: build complete*
...
- [ ] Final commit: *`ridgecoat-decorators`: closed out, tracker and learnings updated*
