# Site Brief — `C.E.G Painting & Decorating`
...
Over a decade of continuous trading as a limited company in a competitive Wiltshire market, with no website — all growth has been through reputation and referral. The demo site makes that reputation findable.

---

## 3. Services offered
- **Interior painting & decorating** (walls, ceilings, woodwork)
- **Exterior painting & decorating** (masonry, render, timber)
- **Wallpapering** (standard and likely specialist papers given trade experience)
- **Preparation & repair work** (filling, sanding, priming — typically the mark of a quality decorator)
...
## 8. SEO Inputs
**Business phone number (for NAP consistency):** 07875 461486
...
**Hero image:** `https://pub-f093c230437d4977b0f5e45607fd9186.r2.dev/demos/library/painter-decorator/hero.webp`
**About image:** `https://pub-f093c230437d4977b0f5e45607fd9186.r2.dev/demos/library/painter-decorator/about.webp`
**CTA background:** `https://pub-f093c230437d4977b0f5e45607fd9186.r2.dev/demos/library/painter-decorator/cta-bg.webp`
**Notes on image usage:** Facebook page is @CorshamDecorators — there may be work photos there. At demo stage, use library images only.
...
*Note: Micro-quotes are synthesised from trade-typical review language (punctuality, tidiness, prep quality, sticking to price). Replace with actual Facebook/Google review quotes at productionisation.*

---

## 11. Anything else
- The business trades under C.E.G Painting & Decorating but is registered as ACM Painting & Decorating Limited. The site should use the trading name (C.E.G) throughout — this is what local customers know.
- No website, no Google Business Profile found, no Checkatrade/TrustATrader listing — the digital footprint is almost entirely the Facebook page. This makes the demo site a significant leap forward. The Facebook 90% recommendation rating is the primary social proof asset.
- The Facebook page handle (@CorshamDecorators) is geographically clear and distinctive — this is the natural domain anchor: `corshamdecorators.co.uk` or `ceg-decorating.co.uk` would both work. Domain availability should be checked.
- Key competitor context: Nick Irelan-Hill (nih-decorating.co.uk) has a clean, professional site; Stan Taylor (painterscirencester.co.uk) is long-established but site is dated and text-heavy; Wiltshire Decorating (wiltshiredecorating.co.uk) is a direct local competitor with a functional but unremarkable site. C.E.G's demo should feel more considered than these — quieter, more confident, less "template."
- No TrustMark registration confirmed. Worth checking before demo is built — if registered, auto-display the badge per standard pipeline process.

---

*Brief prepared: May 2026 | NeoBookworm pipeline | Segment A — Established*
