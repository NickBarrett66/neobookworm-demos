# Site Brief — `G S Jones Electrical`
...
Gary combines genuine craft pride with old-school reliability. He's the electrician your neighbour recommends to you — not found via a Google ad, but passed along by word of mouth. His 100% Facebook recommendation rate and 25-year experience are the proof. A website gives that word-of-mouth credibility a permanent address.

---

## 3. Services offered
- **Service 1:** Consumer unit upgrades / fuse board replacements
- **Service 2:** Fault finding and electrical repairs
- **Service 3:** Lighting installation and upgrades (indoor and garden)
- **Service 4:** Socket and switch installation / relocation
- **Service 5:** Electrical Installation Condition Reports (EICRs)
- **Service 6:** Extractor fan installation and repair
- **Service 7:** Kitchen and extension electrics
- **Service 8:** Smoke detector installation (wired)
...
- **Accreditation 1:** Checkatrade member (profile: gsjoneselectrical) — 100% recommendation rating on Facebook
- **Accreditation 2:** Registered with Companies House as G S JONES ELECTRICAL LIMITED (09068515) — active since 2014
- **Accreditation 3:** Part P competent person registration (implied by trading as domestic Ltd electrician — confirm NICEIC or NAPIT scheme with Gary)
...
## 8. SEO Inputs
**Business phone number (for NAP consistency):** 07971 000 442
...
**CTA background:** `https://pub-f093c230437d4977b0f5e45607fd9186.r2.dev/demos/library/electrician/cta-bg.webp`
**Notes on image usage:** Hero should suggest a professional working in a Bristol home (Victorian interior plausible). CTA background ideally warm-lit interior — avoid dramatic sparks/live-wire clichés.
...
## 11. Anything else
- Gary's Checkatrade profile has not had new reviews in the last 12 months — this is typical for a one-man business that gets repeat and referral work rather than continuously chasing new reviews. The existing reviews are uniformly excellent and the language is genuine.
- Facebook page has 164 likes and 100% recommendation rate — a solid local following. Worth mentioning on-site.
- No Google Business Profile found. This is a significant gap — a GBP listing would help Gary enormously and is worth raising at onboarding as a free quick win.
- Two directors are listed at Companies House (Gary Jones, b. Aug 1979; a second director, b. Oct 1984, appointed May 2017). The second director may be a partner or family member — no evidence they are customer-facing. Brief assumes Gary is sole public face. Please verify before copy is finalised.
- Competitor landscape in South Bristol is active (JPS Electrical, Fairway Electrical, David Fear Electrical, Brunel Electrical, EMC Electrical). Most lead with NICEIC badge and Google reviews count. Gary's site should prominently feature Checkatrade registration and any scheme membership as the direct equivalent.
- Raw review quotes for Nick to select testimonials from:
  - *"Gary is a great electrician who cares about the work he does. Gary was methodical at all times making sure he does a professional job at the same time cleaning up around himself and respecting our home. His timekeeping and communication were great and prices really competitive. He is definitely not afraid of hard work. Lovely guy with a great attitude."* — Dave & Emma, via 3Local
  - *"Quick, tidy and efficient. Great communicator, professional and great end product. My partner and I were very happy with the work on our kitchen and extension."* — Conrad Cheesewright, via 3Local
  - *"Gary turned up on time, completed the job and left the area clean and tidy. Very nice guy and would be very happy to recommend him."* — verified reviewer, BS14, Checkatrade
  - *"Every aspect of Gary's work was excellent. He was easy to contact and returned calls promptly. He arrived on time as arranged to give his quote which was promptly delivered and fairly priced. Gary gave useful advice, based on experience, about where to source the items we needed... Delightful man — the complete professional."* — via Checkatrade
  - *"Fantastic service, reasonable price and Gary is always very polite and friendly. Would highly recommend and won't be using anyone else!"* — via Checkatrade
...
*(Derived: "G S Jones Electrical Ltd" → strip Ltd → lowercase → hyphenate → `gs-jones-electrical`. Fits within 30-char limit.)*
